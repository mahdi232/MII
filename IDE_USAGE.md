...
*Open the project:*<br>
Run Code::Blocks, and open the project in `MII/build/codeblocks`.<br>
Finally, build and run the project.
...
cmake ../MII -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-MII`.<br>
